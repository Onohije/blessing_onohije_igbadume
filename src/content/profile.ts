...
export type Certification = {
  name: string;
  /** Short form shown in brackets after the name, e.g. "NSQ Level 3". */
  abbreviation?: string;
  /** Awarding body, shown under the name and in the modal header. */
  issuer?: string;
  /** When the credential was awarded, e.g. "November 2025". */
  awarded?: string;
  /** Registration/credential number printed on the document. */
  credentialId?: string;
  /**
   * Page images of the credential in /public, in order. When present the
   * certification becomes clickable and opens in a modal viewer.
   */
  pages?: string[];
  /** The original document, offered as a download from the modal. */
  file?: string;
  /** Public verification endpoint printed on the credential. */
  verifyUrl?: string;
};

export const certifications: Certification[] = [
  {
    name: "NSQ Level 3 — Frontend Web Development",
    issuer: "Computer Professionals Registration Council of Nigeria (CPN)",
    awarded: "November 2025",
    credentialId: "CPN/NSQ/24102853",
    pages: ["/certificates/cpn-nsq-1.jpg", "/certificates/cpn-nsq-2.jpg"],
    file: "/certificates/CPN-NSQ-Certificate.pdf",
    verifyUrl: "https://nsq.cpn.gov.ng/verify",
  },
  {
